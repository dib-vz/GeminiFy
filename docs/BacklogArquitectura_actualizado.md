...
Modelado de la clasificación del dominio.

## Descripción

Durante la definición de las entidades del Modelo de Dominio se identificó la necesidad de definir una estrategia completa para la gestión de los Tags.

Aunque los Tags constituyen un mecanismo abierto de clasificación, será necesario establecer políticas para su creación, reutilización, modificación, consolidación y posible eliminación, evitando la proliferación de etiquetas redundantes o ambiguas.

## Objetivo

Definir un modelo de gobierno de los Tags que preserve la coherencia del Catálogo sin limitar la capacidad de clasificación del sistema.

## Aspectos a estudiar

- Criterios de creación.
- Reutilización frente a duplicidad.
- Normalización de nombres.
- Sinónimos.
- Jerarquías o agrupaciones futuras.
...
Durante el diseño de las Reglas de Negocio y del Diccionario de Datos.
