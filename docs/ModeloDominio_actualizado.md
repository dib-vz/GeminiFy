...
# 9. Observaciones de consolidación (v1.1)

Se consolida el modelo conforme a las decisiones arquitectónicas adoptadas:

- Estado, Flag y Tag constituyen mecanismos de clasificación independientes.
- Los Estados son mutuamente excluyentes.
- Las Flags son acumulables e independientes del Estado.
- Los Tags constituyen un mecanismo abierto de clasificación.
- La identidad funcional de una Canción se basa en Tema + Artista(s) de la interpretación canonizada.
- La Participación constituye la única relación entre Canción y Lista.
- La Lista representa el principal mecanismo de generación de conocimiento del sistema.
- La resolución de ambigüedades y la canonización se regirán por las Reglas de Negocio.
